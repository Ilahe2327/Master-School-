    ...
    <div id="contact" className="container mx-auto my-20">
      ...
      <div className="w-full flex justify-start items-center my-10 rounded-2xl" style={{
        ...
        <Card className="w-full text-center bg-transparent flex flex-col mx-auto" >
          ...
          <CardContent>
            <div className={`${inter.className} text-blue-900 w-4/5 mx-auto gap-2 text-xl justify-between flex mt-10`} >
              <p className="bg-white p-5 rounded-2xl cursor-pointer"><b>Telefon : </b> 070 710 33 43</p>
              <p className="bg-white p-5 rounded-2xl cursor-pointer"><b>Email : </b>info@masterschool.az</p>
              <p className="bg-white p-5 rounded-2xl cursor-pointer"><b>İş saatları :</b> 08:30 - 20:00</p>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="w-4/5 h-auto text-xl mx-auto flex flex-col items-start gap-3  ">
              <div className="w-full h-auto text-xl mx-auto flex flex-col items-start gap-3 mt-10 border-white border-3 rounded-2xl p-10 text-white">
